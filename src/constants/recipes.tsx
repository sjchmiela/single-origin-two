...
type RecipeIconProps = { fill: string; size: number };

export type Recipe = {
  title: string;
  id: string;
  modifier?: string;
  icon: (props: RecipeIconProps) => ReactNode;
  image: any;
};
...
export const recipes: { [i: string]: Recipe } = {
  Aeropress: {
    ...
    id: 'Aeropress',
    // modifier: 'Inverted',
    icon: ({ fill, size }: RecipeIconProps) => (
  ...
  Beehouse: {
    ...
    id: 'Beehouse',
    icon: ({ fill, size }: RecipeIconProps) => (
      <BeehouseIcon fill={fill} size={size} />
    ),
    image: BeehouseImage,
  },
  Chemex: {
    ...
    id: 'Chemex',
    icon: ({ fill, size }: RecipeIconProps) => (
      <ChemexIcon fill={fill} size={size} />
    ),
    image: ChemexImage,
  },
  Chemex3Cup: {
    ...
    id: 'Chemex3Cup',
    icon: ({ fill, size }: RecipeIconProps) => (
      <Chemex3CupIcon fill={fill} size={size} />
    ),
  ...
  Clever: {
    ...
    id: 'Clever',
    icon: ({ fill, size }: RecipeIconProps) => (
      <CleverIcon fill={fill} size={size} />
    ),
    image: CleverImage,
  },
  EvaSolo: {
    ...
    id: 'EvaSolo',
    icon: ({ fill, size }: RecipeIconProps) => (
      <EvaSoloIcon fill={fill} size={size} />
    ),
    image: EvaSoloImage,
  },
  FrenchPress3Cup: {
    ...
    id: 'FrenchPress3Cup',
    icon: ({ fill, size }: RecipeIconProps) => (
      <FrenchPressIcon fill={fill} size={size} />
    ),
  ...
  KalitaWave185: {
    ...
    id: 'KalitaWave185',
    icon: ({ fill, size }: RecipeIconProps) => (
      <KalitaWave185Icon fill={fill} size={size} />
    ),
  ...
  KalitaWave155: {
    ...
    id: 'KalitaWave155',
    icon: ({ fill, size }: RecipeIconProps) => (
      <KalitaWave155Icon fill={fill} size={size} />
    ),
    image: KalitaWaveImage,
  },
  V60: {
