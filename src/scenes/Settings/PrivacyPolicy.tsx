  ...
  return (
    <View style={tw("p-4 theme.background.overlay")}>
      ...
      <Text style={tw(`body ${paragraph}`)}>
        This privacy policy governs your use of the software application Single
        Origin (“Application”) for mobile devices that was created by Jon Samp.
        Please read this policy and our Mobile Terms and Conditions carefully;
        by using the App you confirm to have understood and agreed to them.
      </Text>
      ...
      <Text style={tw(`body ${paragraph}`)}>
        ...
        mobile application marketplace or network. You can also opt-out from any
        kind of statistical data that may be stored about your use of the mobile
        application by simply reviewing your Data Sharing inside the
      ...
      <Text style={tw(`body ${paragraph}`)}>
        ...
        have no legitimate overriding interest, or once the purpose for which we
        ...
        the right to request a copy of any information about you that the Group
        holds at any time, and also to have that information corrected if it is
      ...
      <Text style={tw(`body ${paragraph}`)}>
        ...
        legitimate interest, you can ask us to stop for reasons connected to
        your individual situation. We must then do so unless we believe we have
        a legitimate overriding reason to continue processing your personal
        data.
      </Text>
      ...
      <Text style={tw(`body ${paragraph}`)}>
        ...
        https://www.singleoriginapp.com/privacy-policy.html. You are advised to
      ...
      <Text style={tw(`body ${paragraph}`)}>
        ...
        Kingdom. If you reside outside the United Kingdom your information will
        be transferred, processed and stored there under United Kingdom privacy
        standards.
      </Text>
      ...
      <Text style={tw(`body ${paragraph}`)}>
        ...
        actually know are under 16, and no part of our website is structured to
        attract anyone under 16.
      </Text>
      ...
      <Text style={tw(`body ${paragraph}`)}>
        By using Single Origin and providing your information, you authorize us
